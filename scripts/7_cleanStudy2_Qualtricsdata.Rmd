...
exclude_column <- progress_filtered %>%
  mutate(atten_exclusion = case_when("Score Attempt 1" >= 4 ~ 'Include',
                               "Score Attempt 2" >= 4 ~ 'Include',
                               "Score Attempt 3" >= 4 ~ 'Include',
                               TRUE ~ 'Exclude'))
...
212 --> 200 participants = 12 participants failed attention check
...
200 --> 184 participants = 16 participants did not pass the response bias check
