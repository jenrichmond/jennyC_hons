...
clean_data %>%
  ...
  scale_y_continuous(expand = c(0,0),
                     limits = c(0,5)) +
  theme_classic() +
  labs(title = "Perception ratings by group")
...
clean_data %>%
  ...
  scale_y_continuous(expand = c(0,0),
                     limits = c(0,5)) +
  theme_classic() +
  labs(title = "Attitude ratings by group")
...
clean_data %>%
  ...
  scale_y_continuous(expand = c(0,0),
                     limits = c(0,5)) +
  theme_classic() +
  labs(title = "Intention ratings by group")
