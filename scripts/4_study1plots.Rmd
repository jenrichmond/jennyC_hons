...
glimpse(manipcheck)
  ...
  manipcheck$question[manipcheck$question == "gainmanipulation"] <- "Gain-Framed Manipulation"
  manipcheck$question[manipcheck$question == "lossmanipulation"] <- "Loss-Framed Manipulation"
